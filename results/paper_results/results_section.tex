...
Direct PCA regressor (6 layers) & direct\_pca & 1733 & 0.355 & 0.169 & 13.04 & 0.836 & 0.136 & 0.0451 & 0.021 \\
Direct PCA regressor (8 layers) & direct\_pca & 1733 & 0.391 & 0.146 & 12.90 & 0.822 & 0.138 & 0.0462 & 0.026 \\
...
Fourth, phase-sensitive waveform $L_1$ is the main counterexample: Direct PCA regressor (6 layers) has the lowest learned-system waveform $L_1$ (0.0451), so the diffusion results should be interpreted as spectral/transient improvements rather than universal samplewise reconstruction dominance.
